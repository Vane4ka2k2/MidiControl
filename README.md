...
- ?? **Системный трей и Автозапуск** — Фоновая работа возле часов, контекстное меню управления и интеграция с реестром Windows для автозагрузки.
...
- ?? **[Руководство по конфигурации (CONFIGURATION.md)](docs/CONFIGURATION.md)** — Справочник всех параметров `config.json`, привязка MIDI CC/Note и настраиваемые команды.
